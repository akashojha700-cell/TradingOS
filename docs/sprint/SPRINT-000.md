...
> Retrospective record for Sprint 0 (the foundation sprint) and the parallel Sprint 0.1 (engineering governance). Renamed from `SPRINT-001.md` when the numbering was aligned so that Sprint N ↔ `SPRINT-NNN.md`. The corresponding work is documented in [`docs/ROADMAP.md` § Sprint 0](../ROADMAP.md).
